...
if __name__ == "__main__":
    ...
    # Load local data directly to avoid GitHub API issues
    csv_path = "/Users/chuan/Desktop/xiangmu/客户端/nautilus_trader/tests/test_data/binance/ethusdt-trades.csv"
    print(f"Loading test data from: {csv_path}")
    ticks = wrangler.process(CSVTickDataLoader.load(csv_path))
